  ...
  return (
    <div className="container mx-auto px-4">
            ...
            <div className="space-y-6 relative z-10">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Córdoba 1570, Pueblo Esther, Santa Fe</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">+54 341 321-7654</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Consultas rápidas: +54 341 321-7654</p>
                </div>
              </div>
      ...
      <div className="rounded-2xl overflow-hidden h-[450px] shadow-2xl border-4 border-white">
        <iframe 
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3343.319386909863!2d-60.57447432452714!3d-33.07438107354083!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95b7080609551a07%3A0xa250d4046044dca7!2sC%C3%B3rdoba%201570%2C%20S2126%20Pueblo%20Esther%2C%20Santa%20Fe!5e0!3m2!1ses-419!2sar!4v1776454994944!5m2!1ses-419!2sar" 
          width="100%" 
          height="100%" 
          style={{ border: 0 }} 
