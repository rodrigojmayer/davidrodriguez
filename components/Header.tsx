    ...
    <header className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-gray-900 shadow-lg py-3' : 'bg-transparent py-6'}`}>
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <a href="#inicio" className="flex items-center space-x-2">
          <div className="w-14 h-10 bg-blue-600 rounded flex items-center justify-center font-bold text-white text-xl italic">TR</div>
          {/* <img src="../imgs/favicom7.png" className="w-10 h-10" alt="TR"/> */}
